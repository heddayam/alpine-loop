...
const DEFAULT_SCENARIOS_PATH = "data/regions/monterey-carmel/scenarios.json";
...
function usage(): string {
  return "Usage: node --import tsx scripts/research/gate9-monterey-carmel-checkpoint.ts "
...
if ((parsedManifest.schemaVersion !== "5" && parsedManifest.schemaVersion !== "6")
  ...
  throw new Error(`Gate 9 requires the schema-5 or schema-6 ${PACK_ID} manifest`);
}
...
console.log(JSON.stringify({
  formatVersion: 1,
  checkpoint: "gate-9-monterey-carmel",
